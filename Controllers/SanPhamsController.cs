...
namespace MyPhamCheilinus.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaSanPham,TenSanPham,Mau,Anh,Gia,Slkho,NgaySx,LuotMua,MaDanhMuc")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaSanPham,TenSanPham,Mau,Anh,Gia,Slkho,NgaySx,LuotMua,MaDanhMuc")] SanPham sanPham)
        {
